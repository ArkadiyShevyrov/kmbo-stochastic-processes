...
\[
	\begin{aligned}
		s \pi_1(s)-0 & = \pi_1(s)\cdot 0 + \pi_2(s)\cdot 1 + \pi_3(s)\cdot 0 = \pi_2(s),              \\
		s \pi_2(s)-0 & = \pi_1(s)\cdot 0 + \pi_2(s)\cdot(-2) + \pi_3(s)\cdot 1 = -2\pi_2(s)+\pi_3(s), \\
		s \pi_3(s)-1 & = \pi_1(s)\cdot 0 + \pi_2(s)\cdot 1 + \pi_3(s)\cdot(-1) = \pi_2(s)-\pi_3(s).
	\end{aligned}
\]
...
\[
	p'_i(t) = \pi_i(s)-p_i(0) = \sum_{j=1}^3 \pi_j(s)\Lambda_{ji},\quad i=1,2,3.
\]
...
\[
	\pi_1\left(\frac{s(s+2)^2+9s(s+2)^2+ 18s}{s(s+2)^2}\right)=\frac{(s+2)^2}{s(s+2)^2}.
\]