...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 3 p_1(t) + 2 p_3(t), \\
			p_2(t)' = 2 p_1(t) - 2 p_2(t),   \\
			p_3(t)' = p_1(t) + 2 p_2(t) - 2 p_3(t).
		\end{cases}
	$$
...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 3 p_1(t) + 3 p_2(t),          \\
			p_2(t)' = 3 p_1(t) - 5 p_2(t) + 2 p_3(t), \\
			p_3(t)' = 2 p_2(t) - 2 p_3(t).
		\end{cases}
	$$
...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 5 p_1(t) + 2 p_2(t) + p_3(t), \\
			p_2(t)' = 2 p_1(t) - 5 p_2(t) + p_3(t),   \\
			p_3(t)' = 3 p_1(t) + 3 p_2(t) - 2 p_3(t).
		\end{cases}
	$$
...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 3 p_1(t) + p_2(t),          \\
			p_2(t)' = p_1(t) - 2 p_2(t) + 2 p_3(t), \\
			p_3(t)' = 3 p_1(t) + p_2(t) - 2 p_3(t).
		\end{cases}
	$$
...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 8 p_1(t) + p_2(t) + 5 p_3(t), \\
			p_2(t)' = - 3 p_2(t) + 3 p_3(t),          \\
			p_3(t)' = 8 p_1(t) + 2 p_2(t) - 8 p_3(t).
		\end{cases}
	$$
...
\begin{solution}
	...
	$$
		\begin{cases}
			p_1(t)' = - 6 p_1(t) + 2 p_2(t) + p_3(t), \\
			p_2(t)' = p_1(t) - 5 p_2(t) + 2 p_3(t),   \\
			p_3(t)' = 5 p_1(t) + 3 p_2(t) - 3 p_3(t).
		\end{cases}
	$$
