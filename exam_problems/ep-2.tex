...
\begin{solution}
	...
	$$
		...
		\begin{pmatrix}
			...
			\frac{1}{2} & \frac{1}{2} & 0
		\end{pmatrix}
		=\left(\frac{3}{10};\frac{23}{50};\frac{6}{25}\right).
	$$
	...
	$$
		\begin{cases}
			r_1=\frac{1}{4}r_1+\frac{1}{2}r_3, \\
			r_2=\frac{2}{5}r_2+\frac{1}{2}r_3, \\
			r_3=\frac{3}{4}r_1+\frac{3}{5}r_2, \\
			r_1+r_2+r_3=1.
		\end{cases}
		\Rightarrow
		\begin{cases}
			4r_1=r_1+2r_3,                     \\
			5r_2=2r_2+\frac{5}{2}r_3,          \\
			r_3=\frac{3}{4}r_1+\frac{3}{5}r_2, \\
			r_1+r_2+r_3=1.
		\end{cases}
	$$
	...
	$$
		r_3\left(\frac{2}{3}+\frac{5}{6}+1\right)=1
		\Rightarrow
		r_3=\frac{2}{5}.
	$$

	$$
		\bar r=\left(\frac{4}{15};\frac{1}{3};\frac{2}{5}\right).
	$$
...
\begin{conclusion}
	...
	$$
		\vec{p}(2)=\left(\frac{3}{10};\frac{23}{50};\frac{6}{25}\right),
		\bar r=\left(\frac{4}{15};\frac{1}{3};\frac{2}{5}\right).
	$$
...
\begin{condition}
	...
	В цепи Маркова дана матрица $P$ вероятностей перехода за один шаг:
	$p_{21}=0.75$, $p_{11}=p_{32}=p_{23}=0$,
...
\begin{solution}
	...
	p21 p21 мдээ вот это ахуенный билет (там реально на фотке так)
\end{solution}
...
\begin{solution}
	...
	$$
		\begin{cases}
			r_1=\frac{1}{2}r_1+\frac{4}{5}r_2+\frac{1}{2}r_3, \\
			r_2=\frac{1}{5}r_2,                               \\
			r_3=\frac{1}{2}r_1+\frac{1}{2}r_3,                \\
			r_1+r_2+r_3=1.
		\end{cases}
