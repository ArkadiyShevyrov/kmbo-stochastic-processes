...
Термины:
$P_{\text{откз}}$ - вероятность отказа,
...
$r_0=\left(\sum_{i=0}^{n} \frac{\rho^i}{i!}\right)^{-1}$,
$r_n=\frac{\rho^n}{n!}r_0$.

\begin{table}[h]
	\centering
	\begin{tabular}{c|c|c|c}
		                       & $(M|M|n|0)$ 2                                     & $(M|M|n|\infty)$ 3          & $M|M|n|m$                             \\
		\hline
		$P_{\text{откз}}$      & $r_n=\frac{\rho^n}{n!}r_0$                        & $0$                         & $=r_{n+m}=\nu^m \frac{\rho^n}{n!}r_0$ \\
		\hline
		$Q$                    & $1-P_{\text{откз}}$                               & $1-P_{\text{откз}}=1$       & $1-P_{\text{откз}}$                   \\
		\hline
		$A$                    & $\lambda Q$                                       & $\lambda Q=\lambda$         & $\lambda Q$                           \\
		\hline
		$\bar{k}$              & $\bar{z}=\rho Q$                                  & $\rho Q=\rho$               & $\rho Q$                              \\
		\hline
		$\bar{r}$              & $0$                                               & $\nu \frac{r_n}{(1-\nu)^2}$ &                                       \\
		\hline
		$\bar{z}$              & $\bar{k}$                                         & $\bar{k}+\bar{r}$           &                                       \\
		\hline
		$\bar{t}_{\text{оч}}$  & $\frac{\bar{r}}{\lambda}=0$                       & $\frac{\bar{r}}{\lambda}$   &                                       \\
		\hline
		$\bar{t}_{\text{СМО}}$ & $\frac{\bar{z}}{\lambda}=\frac{\bar{k}}{\lambda}$ & $\frac{\bar{z}}{\lambda}$   &                                       \\
		\hline
	\end{tabular}
\end{table}
