...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c}
		                       & $(M|M|1|0)$                                                             & $(M|M|1|\infty)$, $\nu<1$                          & $(M|M|1|m)$                                                                           \\
		\hline
		$r_0$                  & $(1+\rho)^{-1}$                                                         & $1-\rho$                                           & $\rho\ne 1:\frac{1-\rho}{1-\rho^{m+2}}$ | $\rho=1:\frac{1}{m+2}$                      \\
		\hline
...
\begin{solution}
	...
	$(M|M|1|\infty)$,
	$T_{\text{обсл}}=3 \text{мин} = \frac{1}{20} \text{час}$ ,
	$\mu=\frac{1}{T_{\text{обсл}}}=20 \text{клиентов в час}$,
	$\lambda=18$,
	$\rho=\frac{\lambda}{\mu}=\frac{18}{20}=\frac{9}{10}$,

	$$
		t_{\text{оч}}=\frac{\bar{r}}{\lambda}
		=\frac{\rho}{\mu(1-\rho)}
		=\frac{\frac{9}{10}}{20(1-\frac{9}{10})}
		=\frac{9}{20}
	$$
\end{solution}
...
\begin{solution}
	...
	$\mu=\frac{1}{T_{\text{обсл}}}=20 \text{клиентов в час}$,
	$\lambda=20$,
	$\rho=\frac{\lambda}{\mu}=\frac{20}{20}=1$.


	$$
		\rho=1: r_0=\frac{1}{m+2}=\frac{1}{10}
	$$

	$$
		\bar{r} = r_0 \sum_{j=1}^{m} j \rho^j
		=\frac{1}{10} \sum_{j=1}^{8} j 1^j
		=\frac{1}{10} 36 = \frac{18}{5}
	$$
...
\begin{condition}
	...
	если в СМО в среднем поступает 60 заявок в час,
...
\begin{solution}
	...
	$(M|M|2|\infty)$,
	$T_{\text{обсл}}=1 \text{мин} = \frac{1}{60} \text{час}$ ,
	$\mu=\frac{1}{T_{\text{обсл}}}=60 \text{клиентов в час}$,
	$\lambda=60$,
	$\rho=\frac{\lambda}{\mu}=1$,
	$\nu=\frac{\lambda}{n \mu} = \frac{1}{2}$
	...
	$$
		\begin{aligned}
			...
			\right)^{-1}
			\\ & =\left(
			1+ 1 + \frac{1^2}{2}\frac{1}{1-\frac{1}{2}}
			\right)^{-1}
			=\left(
			3
			\right)^{-1}
	...
	$$
		\bar{r}=\nu \frac{r_n}{(1-\nu)^2}
		=\frac{1}{2} \frac{\frac{1}{6}}{(1-\frac{1}{2})^2}
		=\frac{1}{3}
	$$
...
\begin{solution}
	...
	$$
		...
		9\rho^2-9\rho+2=0
		\rightarrow
		\rho_1=\frac{1}{3}, \rho_2=\frac{2}{3}
	$$

	Если $\rho=\frac{1}{3}$:

	$$
		\mu=\frac{\lambda}{\rho}=\frac{120}{\frac{1}{3}}=360
	$$

	$$
		T_{\text{обсл}}=\frac{1}{\mu}=\frac{1}{360}
	$$

	Если $\rho=\frac{2}{3}$:

	$$
		\mu=\frac{\lambda}{\rho}=\frac{120}{\frac{2}{3}}=180
	$$

	$$
		T_{\text{обсл}}=\frac{1}{\mu}=\frac{1}{180}
	$$
\end{solution}

\begin{conclusion}

	Или $T_{\text{обсл}}=\frac{1}{360}$
	или $T_{\text{обсл}}=\frac{1}{180}$
\end{conclusion}
...
\begin{solution}
	...
	$\lambda=8$,
	$T_{\text{обсл}}=15 \text{мин} = \frac{1}{4} \text{час}$ ,
	$\mu=\frac{1}{T_{\text{обсл}}}=4$ клиента в час,
	$\rho=\frac{\lambda}{\mu}=2$.
	...
	$$
		\begin{aligned}
			...
			\right)^{-1}
			=\left(
			\sum_{k=0}^{3}\frac{\rho^k}{k!}
			\right)^{-1}
			= \left(
			1 + \rho + \frac{\rho^2}{2} + \frac{\rho^3}{6}
			\right)^{-1}
			\\ & =\left(
			1 + 2 + \frac{8}{6}
			\right)^{-1}
	...
	$$
		r_{n+m}=\frac{\rho^n}{n!}r_0
		=\frac{2^3}{3!} \frac{3}{19}
		= \frac{4}{19}
	$$
